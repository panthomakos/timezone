...
* Updated with `tzdata-2025b` ([@panthomakos][])
...
* Updated with `tzdata-2023d` ([@panthomakos][])

# 1.3.23

* Updated with `tzdata-2023c` ([@panthomakos][])

# 1.3.22

* Updated with `tzdata-2023b` ([@panthomakos][])

# 1.3.21

* Updated with `tzdata-2022g` ([@panthomakos][])
